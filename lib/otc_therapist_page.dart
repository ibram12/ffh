...
class OtcTherapistPage extends StatefulWidget {
  const OtcTherapistPage({super.key});

  @override
  State<OtcTherapistPage> createState() => _OtcTherapistPageState();
}

class _OtcTherapistPageState extends State<OtcTherapistPage> {
  @override
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (builder) => TherapistConditionsPage()),
                          );
                        },
